...
old_chat_message = ""
TempDirPath = rf"D:\J.A.R.V.I.S. v2.0\Frontend\Files"
GraphicsDirPath = rf"D:\J.A.R.V.I.S. v2.0\Frontend\Graphics"
...
class ChatSection(QWidget):
    ...
    def loadMessages(self):
        ...
        if messages is None:
            ...
            pass
        elif str(old_chat_message) == str(messages):  # Use '==' for comparison
            pass
        else:
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        movie.setScaledSize(QSize(screen_width, max_gif_size))
        gif_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        movie.start()
        gif_label.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Expanding)
        ...
        self.label = QLabel("")
        self.label.setStyleSheet("colour:white; font-size:16px; margin-bottom:0")
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.maximize_button.clicked.connect(self.toggleMaxRestore)
        ...
        title_label = QLabel(f" {str(Assistantname).upper().capitalize()}")
